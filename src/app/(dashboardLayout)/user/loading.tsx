  ...
  return (
    <div className="flex min-h-[60vh] w-full flex-col items-center justify-center gap-4 p-6">
      ...
      <div className="text-center space-y-1">
        <p className="text-base font-semibold text-foreground">Loading Patient Dashboard...</p>
        <p className="text-xs text-muted-foreground">Please wait while we load your records and appointments</p>
      </div>
    </div>
  );
}
